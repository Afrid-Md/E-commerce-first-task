...
import bandMembers from '../../StorePage/Images/Band Members.png'
function AboutBody() {
  return (
    <React.Fragment>
        <div style={{paddingLeft:'300px',paddingRight:'300px'}}>
          <h1 style={{textAlign:'center',paddingBottom:'30px', fontFamily:'fantasy'}}>About</h1>
        <img src={bandMembers} style={{width:'auto',borderRadius:'50%', height:'300px',float:'left',padding:'20px'}}></img>
        <p>
    ...
    {/* <div style={{paddingLeft:'300px', paddingRight:'238px', paddingTop:'0px',margin:'0px'}}>
    <p>
        </p>
    </div> */}
